#ifndef DOMINO_SUPPORT_FORMATVARIADIC_H_
#define DOMINO_SUPPORT_FORMATVARIADIC_H_

#include <domino/support/FormatCommon.h>
...
class formatv_object_base {
 protected:
  ...
  static std::pair<ReplacementItem, StringRef> splitLiteralAndReplacement(
      StringRef Fmt);
 ...
 public:
  void format(raw_ostream &S) const {
    for (auto &R : parseFormatString(Fmt)) {
      if (R.Type == ReplacementType::Empty) continue;
...
#endif  // DOMINO_SUPPORT_FORMATVARIADIC_H_
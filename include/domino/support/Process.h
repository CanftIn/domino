#ifndef DOMINO_SUPPORT_PROCESS_H_
#define DOMINO_SUPPORT_PROCESS_H_
...
class Process {
 public:
  ...
  /// considered.
  static std::optional<std::string> FindInEnvPath(
      StringRef EnvName, StringRef FileName, ArrayRef<std::string> IgnoreList,
      char Separator = EnvPathSeparator);

  static std::optional<std::string> FindInEnvPath(
      StringRef EnvName, StringRef FileName, char Separator = EnvPathSeparator);
...
#endif  // DOMINO_SUPPORT_PROCESS_H_

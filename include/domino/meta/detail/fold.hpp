...
struct meta_fold_impl {};

template <template <class...> class L, class... T, class V,
          template <class...> class F>
struct meta_fold_impl<L<T...>, V, F> {
...
template <template <class...> class L, class T1, class... T, class V,
          template <class...> class F>
struct meta_fold_impl<L<T1, T...>, V, F> {
  using type = typename meta_fold_impl<L<T...>, F<V, T1>, F>::type;
};
...
struct meta_fold_impl<L<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T...>, V, F> {
  using type = typename meta_fold_impl<
      L<T...>,
...
template <class L, class V, template <class...> class F>
using meta_fold = typename detail::meta_fold_impl<L, V, F>::type;

template <class L, class V, class Q>
using meta_fold_q = typename detail::meta_fold_impl<L, V, Q::template fn>;

...
namespace detail {
template <>
struct is_hashable_data<LargeTestInteger> : std::true_type {};
...
TEST(HashingTest, HashWithHashBuilder) {
  ...
  EXPECT_NE(static_cast<size_t>(domino::hash_value(S)), static_cast<size_t>(0));
}

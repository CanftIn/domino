#ifndef DOMINO_SUPPORT_POINTER_LIKE_TYPE_TRAITS_H_
#define DOMINO_SUPPORT_POINTER_LIKE_TYPE_TRAITS_H_
...
/// PointerLikeTypeTraits is a C++ template class whose purpose is to provide a
/// set of type features for parsing and processing pointer types at run time.
///
/// PtrT: indicates the type of pointer to be analyzed.
/// PointeeT: indicates the type to which PtrT points.
/// PtrTraits: a feature class representing pointer type PtrT to provide
///            information about PtrT.
///
/// getAsVoidPointer : Returns a pointer to void* to an object of type PtrT.
/// getFromVoidPointer : Converts a pointer to void* back to a pointer to PtrT.
/// NumLowBitsAvailable : the number of unused bits in a pointer of type PtrT.
template <typename T>
...
#endif  // DOMINO_SUPPORT_POINTER_LIKE_TYPE_TRAITS_H_